...
export default function ChatInterface({
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      // Approximate keyboard height using VisualViewport.
      // This should only affect the input bar positioning, not the whole layout.
  ...
  // Measure the input bar height so we can pad the message list and avoid overlap.
  useEffect(() => {
    ...
    const update = () => {
      ...
      setInputBarHeightPx(next > 0 ? next : 0);
    };
