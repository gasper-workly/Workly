...
export default function ProviderOnboardingStep2() {
  ...
  const handleNext = () => {
    router.push('/onboarding/provider/3');
  };
    ...
    <main className="min-h-screen flex flex-col items-center justify-between bg-white">
      <div className="w-full max-w-md mx-auto px-6 pt-16 pb-6">
        <h1 className="text-3xl font-bold text-black leading-tight whitespace-pre-line">
          {t('onboarding.provider.step2.title')}
        </h1>

        <div className="mt-8 space-y-6">
          <div className="flex items-start gap-3">
            <MapPinIcon className="h-7 w-7 text-violet-600 shrink-0" />
            <p className="text-black text-lg">{t('onboarding.provider.step2.bullet1')}</p>
          </div>

          <div className="flex items-start gap-3">
            <CheckCircleIcon className="h-7 w-7 text-violet-600 shrink-0" />
            <p className="text-black text-lg">{t('onboarding.provider.step2.bullet2')}</p>
          </div>

          <div className="flex items-start gap-3">
            <StarIcon className="h-7 w-7 text-violet-600 shrink-0" />
            <p className="text-black text-lg">{t('onboarding.provider.step2.bullet3')}</p>
          </div>
        </div>
      </div>
